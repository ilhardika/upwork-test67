    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <h1 className="text-xl font-semibold text-gray-900">Healthcare Dashboard</h1>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          {/* Page Header */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Dashboard settings</h2>
            <p className="text-gray-600">Configure your patient targeting and batch processing settings</p>
          </div>
            ...
            <CardContent className="p-4">
              <div className="flex">
                ...
                <div className="text-sm text-blue-700">
                  <p className="font-medium mb-1">Batch Processing Information</p>
                  <p>Batches will be processed according to your configured settings. Monitor the progress in the activity log.</p>
                </div>
              </div>
            </CardContent>
          </Card>
